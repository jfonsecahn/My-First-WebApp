...
<%
    ...
    String modelo = "Especialidad";
    String identificador = "Especialidades";
    String titulo = "Administracion de " + identificador;
    String permisos = "";
    String[] lista_permisos = {};
    if (session.getAttribute("rol") != null) {
        permisos = p.obtener_permisos_usuario_modulo(Integer.parseInt(session.getAttribute("rol").toString()), 6);
        if (!permisos.equals("")) {
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <jsp:include page='formulario.jsp'>
                        ...
                        <jsp:param name="campos" value="id;nombre" />
                        <jsp:param name="titulos" value="Id;Nombre" />
                        <jsp:param name="tipos_input" value="text;text;" />
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <jsp:include page='formulario.jsp'>
                        ...
                        <jsp:param name="titulos" value="Nombre;" />
...
<variables id="variables" modulo="especialidades" campos="*" puede_editar="<%=puede_editar%>"  puede_eliminar="<%=puede_eliminar%>"/>
