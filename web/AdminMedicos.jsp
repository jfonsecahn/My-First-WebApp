...
<%
    ...
    String modelo = "Médico";
    String identificador = "Médicos";
    String titulo = "Administracion de " + identificador;
    String permisos = "";
    String[] lista_permisos = {};
    if (session.getAttribute("rol") != null) {
        permisos = p.obtener_permisos_usuario_modulo(Integer.parseInt(session.getAttribute("rol").toString()), 7);
        if (!permisos.equals("")) {
...
<div class="row">
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                   ...
                   <jsp:param name="campos" value="id;identidad;nombres;apellidos;correo;telefono;especialidad_principal;presentacion;imagen;estado;nombre_usuario;contrasenia" />
                        <jsp:param name="titulos" value="Id;Identidad;Nombres;Apellidos;Correo;Teléfono;Especialidad Principal;Presentación;Imagen;Estado;Nombre Usuario;Contraseña" />
                        <jsp:param name="tipos_input" value="text;text;text;text;email;text;text;textarea;file;select;text;password" />
                        <jsp:param name="clases_input" value="col-6;col-6;col-6;col-6;col-6;col-6;col-6;col-12;col-6;col-6;col-6;col-6;col-6" />
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <jsp:include page='formulario.jsp'>
                        ...
                        <jsp:param name="campos" value="identidad;nombres;apellidos;correo;telefono;especialidad_principal;presentacion;imagen;estado;nombre_usuario;contrasenia" />
                        <jsp:param name="titulos" value="Identidad;Nombres;Apellidos;Correo;Teléfono;Especialidad Principal;Presentación;Imagen;Estado;Nombre Usuario;Contraseña" />
                        <jsp:param name="tipos_input" value="text;text;text;email;text;text;textarea;file;select;text;password" />
                        <jsp:param name="clases_input" value="col-6;col-6;col-6;col-6;col-6;col-6;col-12;col-6;col-6;col-6;col-6;col-6" />
                        <jsp:param name="opciones" value="<%=opciones%>" />
                    </jsp:include>  
                </div>
                <div class="modal-footer">
    ...
    <jsp:include page="lista.jsp" >  
        ...
        <jsp:param name="titulos" value="Id;Identidad;Nombre Usuario;Contraseña;Nombres;Apellidos;Teléfono;Correo;Estado;Especialidad Principal;Presentación;Imagen" />
        <jsp:param name="mostrar_acciones" value="<%=mostrar_acciones%>" />
        <jsp:param name="puede_agregar" value="<%=puede_agregar%>" />
    </jsp:include>
</div>  
<variables id="variables" modulo="medicos"  puede_editar="<%=puede_editar%>"  puede_eliminar="<%=puede_eliminar%>"/>
