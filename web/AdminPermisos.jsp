...
<%
    ...
    String modelo = "Permiso de Rol";
    String identificador = "Permisos de Roles";
    String titulo = "Administracion de " + identificador;
    String permisos = "";
    String[] lista_permisos = {};
    if (session.getAttribute("rol") != null) {
        permisos = p.obtener_permisos_usuario_modulo(Integer.parseInt(session.getAttribute("rol").toString()), 3);
        if (!permisos.equals("")) {
    ...
    String opciones = p.obtener_opciones_select("roles", "id as value,nombre as label") + "-" + p.obtener_opciones_select("modulos", "id as value,nombre as label") + "-null";
...
<div class="row">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <jsp:include page='formulario.jsp'>
                        ...
                        <jsp:param name="campos" value="id;rol;modulo;permiso" />
                        <jsp:param name="titulos" value="Id;Rol;Módulo;Permiso" />
                        <jsp:param name="tipos_input" value="text;select;select;select" />
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <jsp:include page='formulario.jsp'>
                        ...
                        <jsp:param name="campos" value="rol;modulo;permiso" />
                        <jsp:param name="titulos" value="Rol;Módulo;Permiso" />
                        <jsp:param name="tipos_input" value="select;select;select" />
                        <jsp:param name="clases_input" value="col-6;col-6;col-6" />
                        <jsp:param name="opciones" value="<%=opciones%>" />
                    </jsp:include>  
                </div>
                <div class="modal-footer">
    ...
    <jsp:include page="lista.jsp" >  
        ...
        <jsp:param name="titulos" value="Id;Id Rol;Nombre Rol;Id Módulo;Nombre Módulo;Id Permiso;Nombre Permiso" />
        <jsp:param name="mostrar_acciones" value="<%=mostrar_acciones%>" />
        <jsp:param name="puede_agregar" value="<%=puede_agregar%>" />
    </jsp:include>
</div>  
<variables id="variables" modulo="permisos_rol" campos="*" puede_editar="<%=puede_editar%>"  puede_eliminar="<%=puede_eliminar%>"/>
<optiones id="opciones" modulo="permisos_modulos"  identificadores="modulo;" receptores="permiso;"/>
