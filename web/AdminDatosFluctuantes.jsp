...
<%
    ...
    String modelo = "Dato Fluctuante";
    String identificador = "Datos Fluctuantes";
    String titulo = "Administracion de " + identificador;
    String permisos = "";
    String[] lista_permisos = {};
    if (session.getAttribute("rol") != null) {
        permisos = p.obtener_permisos_usuario_modulo(Integer.parseInt(session.getAttribute("rol").toString()), 18);
        if (!permisos.equals("")) {
...
<div class="row">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <jsp:include page='formulario.jsp'>
                        ...
                        <jsp:param name="campos" value="id;impuesto;rango_inicial;rango_final;fecha_limite" />
                        <jsp:param name="titulos" value="Id;Impuesto Sobre Ventas;Rango Inicio Facturación;Rango Fin Facturación;Fecha Límite de Emisión" />
                        <jsp:param name="tipos_input" value="text;number;text;text;date" />
    ...
    <jsp:include page="lista.jsp" >  
        ...
        <jsp:param name="titulos" value="Id;Impuesto sobre Ventas;Rango Inicio Facturación;Rango Final Facturación;Fecha Límite de Emisión" />
        <jsp:param name="mostrar_acciones" value="<%=mostrar_acciones%>" />
        <jsp:param name="puede_agregar" value="<%=puede_agregar%>" />
    </jsp:include>
</div>  
<variables id="variables" modulo="datos_fluctuantes" campos="*" puede_editar="<%=puede_editar%>"  puede_eliminar="<%=puede_eliminar%>"/>
