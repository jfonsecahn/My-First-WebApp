...
<%
    ...
    String modelo = "Cita";
    String identificador = "Citas";
    String titulo = "Administracion de " + identificador;
    String permisos = "";
    String[] lista_permisos = {};
    if (session.getAttribute("rol") != null) {
        permisos = p.obtener_permisos_usuario_modulo(Integer.parseInt(session.getAttribute("rol").toString()), 17);
        if (!permisos.equals("")) {
    ...
    String opciones = p.obtener_opciones_select("usuarios where id_rol=3", "id as value,concat(nombres,' ',apellidos) as label") + "-" + p.obtener_opciones_select("servicios where estado='Disponible'", "id as value,nombre as label") + "-null";
%>
...
<div class="row">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <jsp:include page='formulario.jsp'>
                        <jsp:param name="id" value="formulario_actualizar_cita" />
                        <jsp:param name="campos" value="id;usuario;servicio;medico;fecha" />
                        <jsp:param name="titulos" value="Id;Paciente;Servicio;Médico;Fecha" />
                        <jsp:param name="tipos_input" value="text;select;select;select;date" />
                        <jsp:param name="clases_input" value="col-6;col-6;col-6;col-6;col-6" />
                        <jsp:param name="opciones" value="<%=opciones%>" />
                    </jsp:include>  
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary ingreso" onclick="guardar('formulario_actualizar_cita');" >Actualizar </button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade bs-example-modal-lg"  id="modal_insertar" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <jsp:include page='formulario.jsp'>
                        <jsp:param name="id" value="formulario_citas" />
                        <jsp:param name="campos" value="usuario;servicio;medico;fecha" />
                        <jsp:param name="titulos" value="Paciente;Servicio;Médico;Fecha" />
                        <jsp:param name="tipos_input" value="select;select;select;date" />
                        <jsp:param name="clases_input" value="col-6;col-6;col-6;col-6" />
                        <jsp:param name="opciones" value="<%=opciones%>" />
                    </jsp:include>  
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary ingreso" onclick="guardar('formulario_citas')">Guardar</button>
                </div>
    ...
    <jsp:include page="lista.jsp" >  
        ...
        <jsp:param name="titulos" value="Id;Id Servicio;Nombre Servicio;Id Médico;Nombre Médico;Fecha;Id Paciente;Nombre Paciente;Estado" />
...
<variables id="variables" modulo="admin_citas"  puede_editar="<%=puede_editar%>"  puede_eliminar="<%=puede_eliminar%>"  titulo="<%=identificador%>"></variables>
    <jsp:include page="layouts/admin_footer.jsp" > 
        <jsp:param name="nombre" value="<%=datos[1]%>" />
        <jsp:param name="js" value="citas.js;" />
    </jsp:include>
