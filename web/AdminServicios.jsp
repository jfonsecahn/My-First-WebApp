...
<%
    ...
    String modelo = "Servicio";
    String identificador = "Servicios";
    String titulo = "Administracion de " + identificador;
    String permisos = "";
    String[] lista_permisos = {};
    if (session.getAttribute("rol") != null) {
        permisos = p.obtener_permisos_usuario_modulo(Integer.parseInt(session.getAttribute("rol").toString()), 5);
        if (!permisos.equals("")) {
...
<div class="row">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <jsp:include page='formulario.jsp'>
                        ...
                        <jsp:param name="campos" value="id;nombre;descripcion;icono;precio;estado" />
                        <jsp:param name="titulos" value="Id;Nombre;Descripción;Icono;Precio;Estado" />
                        <jsp:param name="tipos_input" value="text;text;textarea;text;number;select" />
                        <jsp:param name="clases_input" value="col-6;col-6;col-12;col-6;col-6;col-6" />
                        <jsp:param name="opciones" value="Disponible:Disponible;No Disponible:No Disponible" />
                    </jsp:include>  
                </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <jsp:include page='formulario.jsp'>
                        ...
                        <jsp:param name="campos" value="nombre;descripcion;icono;precio;estado" />
                        <jsp:param name="titulos" value="Nombre;Descripción;Icono;Precio;Estado" />
                        <jsp:param name="tipos_input" value="text;textarea;text;number;select" />
                        <jsp:param name="clases_input" value="col-6;col-12;col-6;col-6;col-6" />
                        <jsp:param name="opciones" value="Disponible:Disponible;No Disponible:No Disponible" />
                    </jsp:include>  
                </div>
                <div class="modal-footer">
    ...
    <jsp:include page="lista.jsp" >  
        ...
        <jsp:param name="titulos" value="Id;Nombre;Descripción;Icono;Estado;Precio" />
        <jsp:param name="mostrar_acciones" value="<%=mostrar_acciones%>" />
        <jsp:param name="puede_agregar" value="<%=puede_agregar%>" />
    </jsp:include>
</div>  
<variables id="variables" modulo="servicios" campos="*" puede_editar="<%=puede_editar%>"  puede_eliminar="<%=puede_eliminar%>"/>
