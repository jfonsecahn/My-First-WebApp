...
<%
    ...
    String modelo = "Especialidad de Médico";
    String identificador = "Especialidades de Médico";
    String titulo = "Administracion de " + identificador;
    String permisos = "";
    String[] lista_permisos = {};
    if (session.getAttribute("rol") != null) {
        permisos = p.obtener_permisos_usuario_modulo(Integer.parseInt(session.getAttribute("rol").toString()), 11);
        if (!permisos.equals("")) {
    ...
    String opciones = p.obtener_opciones_select("usuarios where id_rol=4", "id as value,concat(id,' ',nombres,' ',apellidos) as label")+"-" + p.obtener_opciones_select("especialidades", "id as value,nombre as label");
%>
...
<div class="row">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <jsp:include page='formulario.jsp'>
                        ...
                        <jsp:param name="campos" value="id;medico;especialidad" />
                        <jsp:param name="titulos" value="Id;Médico;Especialidad" />
                        <jsp:param name="tipos_input" value="text;select;select" />
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <jsp:include page='formulario.jsp'>
                        ...
                        <jsp:param name="campos" value="medico;especialidad" />
                        <jsp:param name="titulos" value="Médico;Especialidad" />
                        <jsp:param name="tipos_input" value="select;select" />
                        <jsp:param name="clases_input" value="col-6;col-6" />
                        <jsp:param name="opciones" value="<%=opciones%>" />
                    </jsp:include>  
                </div>
                <div class="modal-footer">
    ...
    <jsp:include page="lista.jsp" >  
        ...
        <jsp:param name="titulos" value="Id;Id Médico;Médico;Id Especialidad;Especialidad" />
        <jsp:param name="mostrar_acciones" value="<%=mostrar_acciones%>" />
        <jsp:param name="puede_agregar" value="<%=puede_agregar%>" />
    </jsp:include>
</div>  
<variables id="variables" modulo="especialidades_medicos"  puede_editar="<%=puede_editar%>"  puede_eliminar="<%=puede_eliminar%>"/>
