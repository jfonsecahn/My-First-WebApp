...
<%
    ...
    String modelo = "Especialidad de Servicio";
    String identificador = "Especialidades de Servicio";
    String titulo = "Administracion de " + identificador;
    String permisos = "";
    String[] lista_permisos = {};
    if (session.getAttribute("rol") != null) {
        permisos = p.obtener_permisos_usuario_modulo(Integer.parseInt(session.getAttribute("rol").toString()), 12);
        if (!permisos.equals("")) {
    ...
    String opciones = p.obtener_opciones_select("servicios", "id as value,nombre as label")+ "-"+p.obtener_opciones_select("especialidades", "id as value,nombre as label");
%>
...
<div class="row">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <jsp:include page='formulario.jsp'>
                        ...
                        <jsp:param name="campos" value="id;servicio;especialidad" />
                        <jsp:param name="titulos" value="Id;Servicio;Especialidad" />
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <jsp:include page='formulario.jsp'>
                        ...
                        <jsp:param name="campos" value="servicio;especialidad" />
                        <jsp:param name="titulos" value="Servicio;Especialidad" />
    ...
    <jsp:include page="lista.jsp" >  
        ...
        <jsp:param name="titulos" value="Id;Id Servicio;Servicio;Id Especialidad;Especialidad" />
        <jsp:param name="mostrar_acciones" value="<%=mostrar_acciones%>" />
        <jsp:param name="puede_agregar" value="<%=puede_agregar%>" />
    </jsp:include>
</div>  
<variables id="variables" modulo="especialidades_servicios"  puede_editar="<%=puede_editar%>"  puede_eliminar="<%=puede_eliminar%>"/>
