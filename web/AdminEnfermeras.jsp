...
<%
    ...
    String modelo = "Enfermera";
    String identificador = "Enfermeras";
    String titulo = "Administracion de " + identificador;
    String permisos = "";
    String[] lista_permisos = {};
    if (session.getAttribute("rol") != null) {
        permisos = p.obtener_permisos_usuario_modulo(Integer.parseInt(session.getAttribute("rol").toString()), 8);
        if (!permisos.equals("")) {
...
<variables id="variables" modulo="enfermeras"  puede_editar="<%=puede_editar%>"  puede_eliminar="<%=puede_eliminar%>"/>
