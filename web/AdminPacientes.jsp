...
<%
    ...
    String modelo = "Paciente";
    String identificador = "Pacientes";
    String titulo = "Administracion de " + identificador;
    String permisos = "";
    String[] lista_permisos = {};
    if (session.getAttribute("rol") != null) {
        permisos = p.obtener_permisos_usuario_modulo(Integer.parseInt(session.getAttribute("rol").toString()), 9);
        if (!permisos.equals("")) {
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                   ...
                   <jsp:param name="campos" value="id;identidad;nombres;apellidos;correo;telefono;imagen;estado;nombre_usuario;contrasenia" />
                        <jsp:param name="titulos" value="Id;Identidad;Nombres;Apellidos;Correo;Teléfono;Imagen;Estado;Nombre Usuario;Contraseña" />
                        <jsp:param name="tipos_input" value="text;text;text;text;email;text;file;select;text;password" />
                        <jsp:param name="clases_input" value="col-6;col-6;col-6;col-6;col-6;col-6;col-6;col-6;col-6;col-6;col-6" />
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <jsp:include page='formulario.jsp'>
                        ...
                        <jsp:param name="campos" value="identidad;nombres;apellidos;correo;telefono;imagen;estado;nombre_usuario;contrasenia" />
                        <jsp:param name="titulos" value="Identidad;Nombres;Apellidos;Correo;Teléfono;Imagen;Estado;Nombre Usuario;Contraseña" />
                        <jsp:param name="tipos_input" value="text;text;text;email;text;file;select;text;password" />
...
<variables id="variables" modulo="pacientes"  puede_editar="<%=puede_editar%>"  puede_eliminar="<%=puede_eliminar%>" titulo="<%=identificador%>"/>
